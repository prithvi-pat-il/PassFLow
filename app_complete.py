...
# Ensure database tables and required folders exist when running under a WSGI server
...
def initialize_application():
    try:
        ...
        # Fail-safe: don't crash app on init issues; logs will appear in server output
